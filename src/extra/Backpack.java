...
class Ruler extends Supply {
	Ruler() {
		this.name = "ruler";
		System.out.println("You found your ruler!!!! Sigh...");
	}

	public void measure() {
		System.out.println("Now you can measure your mouse! Sigh...");
	}
}
...
class Textbook extends Supply {
	Textbook() {
		this.name = "textbook";
		System.out.println("You got your boring textbook Sigh...");
	}

	public void read() {
		System.out.println("The history of Iceland is long and interesting Sigh...");
	}
}